...
pig -param orig=/data/fhr/text/20140512 -param fetchids=/user/bcolloran/data/fhrDeorphaning_2014-05-12/headRecordsFinalDocIds.txt -param jointype=merge -param output=fhrDeorphaned_2014-05-12 fetch_reports.aphadke.pig
'''
    os.chdir("/home/bcolloran/jydoop_bcolloran2/jydoop/")
